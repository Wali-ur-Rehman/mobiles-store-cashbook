...
class ProductController extends Controller
{
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        Product::create([
            ...
            'imei_number1' => $request->imei_number1 ?? null,
            'imei_number2' => $request->imei_number2 ?? null,
            'seller_cnic' => $request->seller_cnic ?? null,
    ...
    {
        $product = Product::where("uuid", $uuid)->with('supplier')->firstOrFail();
        // Generate a barcode
    ...
    public function update(UpdateProductRequest $request, $uuid)
    {
        ...
        $product->imei_number1 = $request->imei_number1 ?? null;
        $product->imei_number2 = $request->imei_number2 ?? null;
        $product->seller_cnic = $request->seller_cnic ?? null;
