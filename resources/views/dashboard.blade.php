            ...
            <div class="row g-2 align-items-center">
                ...
                <form method="GET" action="{{ route('dashboard') }}" class="d-flex align-items-center">
                    <div class="col-auto text-secondary">
                        ...
                        <input type="date" id="startDate" name="startDate" value="{{ request('startDate') }}" class="form-control" aria-label="Start date">
                    </div>
                    <div class="col-auto text-secondary ms-2">
                        <label for="endDate" class="form-label mb-0">End Date:</label>
                        <input type="date" id="endDate" name="endDate" value="{{ request('endDate') }}" class="form-control" aria-label="End date">
                    </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                Rs {{ number_format($cashInHand, 2) }} Cash In Hand
                                            </div>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                Rs {{ number_format($totalProfit, 2) }} Profit
                                            </div>
                                            {{-- <div class="text-muted">
                                                {{ $transactionCount }} transactions
                                            </div> --}}
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                Rs {{ number_format($totalSales, 2) }} Total Sales
                                            </div>
                                            {{-- <div class="text-muted">
                                                {{ $transactionCount }} transactions
                                            </div> --}}
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                Rs {{ number_format($totalExpenses, 2) }} Total Expenses
                                            </div>
                                            {{-- <div class="text-muted">
                                                {{ $transactionCount }} transactions
                                            </div> --}}
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                Rs {{ number_format($totalDebit, 2) }} Total Debit
                                            </div>
                                            {{-- <div class="text-muted">
                                                {{ $transactionCount }} transactions
                                            </div> --}}
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                Rs {{ number_format($totalCredit, 2) }} Total Credit
                                            </div>
                                            {{-- <div class="text-muted">
                                                {{ $transactionCount }} transactions
                                            </div> --}}
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                Rs {{ number_format($totalPurchase, 2) }} Total Stock
                                            </div>
                                            {{-- <div class="text-muted">
                                                {{ $transactionCount }} transactions
                                            </div> --}}
